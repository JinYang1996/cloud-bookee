...
@Service
public class OrderMessageServiceImpl implements MessageTaskTypeService,InitializingBean {
	...
	public String sendMessage(String userType) throws Exception {
		...
		return UserTypeEnum.getValueByKey(userType)+MessageEnum.ORDER.getValue()+"消息推送";
	}

	@Override
	public void afterPropertiesSet() throws Exception {
		MessageTaskTypeServiceStrategyFactory.register(MessageEnum.ORDER.getKey(), this);
	}
