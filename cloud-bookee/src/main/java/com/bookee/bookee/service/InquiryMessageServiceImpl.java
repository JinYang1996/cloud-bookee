...
@Service
public class InquiryMessageServiceImpl implements MessageTaskTypeService,InitializingBean {
	...
	public String sendMessage(String userType) throws Exception {
		...
		return UserTypeEnum.getValueByKey(userType)+MessageEnum.INQUIRY.getValue()+"消息推送";
	}

	@Override
	public void afterPropertiesSet() throws Exception {
		MessageTaskTypeServiceStrategyFactory.register(MessageEnum.INQUIRY.getKey(), this);
	}
